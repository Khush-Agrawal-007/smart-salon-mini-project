    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <div className="relative group">
                ...
                <div className="relative px-8 py-10 bg-slate-900 border border-white/10 ring-1 ring-gray-900/5 rounded-2xl leading-none">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <select
                                className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <ReactDatePicker
                                        ...
                                        className="w-full bg-slate-800/50 border border-white/10 text-white rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none backdrop-blur-xl transition hover:bg-slate-800/70"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                className="w-full bg-slate-800/50 border border-white/10 text-white rounded-xl px-4 py-3 h-24 focus:ring-2 focus:ring-purple-500 focus:outline-none transition resize-none placeholder:text-slate-600"
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                className={`w-full py-4 px-4 rounded-xl shadow-lg transform transition hover:scale-[1.02] active:scale-[0.98] font-semibold tracking-wide
                  ${status === 'loading'
